...
public class RaccoonAIWash extends Goal {
        ...
        if (targetPos != null && waterPos != null) {
            ...
            if (dist <= 1F) {
                ...
                if(washTime > 100 || raccoon.isHoldingSugar() && washTime > 20){
                    ...
                    if(this.raccoon.getMainHandItem().getItem().hasCraftingRemainingItem()){
                        this.raccoon.spawnAtLocation(this.raccoon.getMainHandItem().getItem().getCraftingRemainingItem());
                    }
    ...
    public BlockPos generateTarget() {
        ...
        final RandomSource random = this.raccoon.getRandom();
        int range = 32;
        for (int i = 0; i < 15; i++) {
