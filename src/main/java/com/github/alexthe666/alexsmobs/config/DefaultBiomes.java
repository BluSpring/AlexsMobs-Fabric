...
public class DefaultBiomes {
    ...
    public static final SpawnBiomeData ALL_FOREST = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:forest", 1)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 17)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 24)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:skylands_autumn", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 25)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "biomesoplenty:redwood_forest", 25)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 26)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:taiga", 26)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 27)
    ...
    public static final SpawnBiomeData ROADRUNNER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:badlands", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:desert", 12);
    ...
    public static final SpawnBiomeData ORCA = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 1)
    ...
    public static final SpawnBiomeData SUNBIRD = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 28)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:white_cliffs", 28)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 29)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:mountain", 29)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 30)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:mountain_peak", 30)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 31)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:mountain_slope", 31)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 32)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:extreme_hills", 32)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 33)
    ...
    public static final SpawnBiomeData GORILLA = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_savanna", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_mountain", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_slope", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_peak", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:extreme_hills", 0)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_dry", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_mountain", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_slope", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_peak", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:extreme_hills", 7)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_dry", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_savanna", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_mountain", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_slope", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_peak", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:extreme_hills", 9);
    ...
    public static final SpawnBiomeData HAMMERHEAD = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_hot", 3);
    ...
    public static final SpawnBiomeData LOBSTER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:stony_shores", 4);
    ...
    public static final SpawnBiomeData KOMODO_DRAGON = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:vegetation_dense", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:vegetation_sparse", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:badlands", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
    ...
    public static final SpawnBiomeData CAPUCHIN_MONKEY = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:forest", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_dry", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 0)
            ...
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "minecraft:bamboo_jungle", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_dry", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_savanna", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "minecraft:mangrove_swamp", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:amethyst_canyon", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:amethyst_rainforest", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 5)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:jungle_mountains", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 6)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:rocky_jungle", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:tropical_jungle", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:skylands_summer", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 10)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "byg:guiana_shield", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 11)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_dry", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_savanna", 12)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_plains", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_forest", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_savanna", 13);
    ...
    public static final SpawnBiomeData CAVES = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:underground", 15);
    ...
    public static final SpawnBiomeData MOOSE = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:snowy_maple_woods", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
            ...
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:skylands_winter", 15)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 16)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:snowy", 16)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:wasteland", 16);
    ...
    public static final SpawnBiomeData RACCOON = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 23)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:forest", 23)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:savanna", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:plains", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 25)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:taiga", 25);
    ...
    public static final SpawnBiomeData SEAL = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:ocean", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:beach", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:ocean", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 7);

    public static final SpawnBiomeData COCKROACH = new SpawnBiomeData()
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_ocean", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "forge:is_mushroom", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mushroom", 0)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "minecraft:deep_dark", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 1)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:cave/andesite_caves", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:caves", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 14)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:underground", 14);
    ...
    public static final SpawnBiomeData SHOEBILL = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "minecraft:is_mountain", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_slope", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mountain_peak", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:extreme_hills", 6);
    ...
    public static final SpawnBiomeData ELEPHANT = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "minecraft:bamboo_jungle", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:savanna", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:forest", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:desert", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:desert", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 14)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "regions_unexplored:bamboo_forest", 14)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 15)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:plains", 15)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 15);
    ...
    public static final SpawnBiomeData SNOW_LEOPARD = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:emerald_peaks", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 9)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:rocky_mountains", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 10)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:scarlet_mountains", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 11)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:snowy_shield", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "terralith:skylands_winter", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:snowy", 12);
    ...
    public static final SpawnBiomeData MUNGUS = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:mushroom", 2);
    ...
    public static final SpawnBiomeData GUSTER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:in_nether", 9)
    ...
    public static final SpawnBiomeData STRADDLER = new SpawnBiomeData()
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:in_nether", 0)
    ...
    public static final SpawnBiomeData SAVANNA_AND_MESA = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:savanna", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:badlands", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 13)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:mesa", 13);
    ...
    public static final SpawnBiomeData ICE_FREE_RIVER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:river", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 3);
    ...
    public static final SpawnBiomeData CACHALOT_WHALE = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:ocean", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 4);
    ...
    public static final SpawnBiomeData BEACHED_CACHALOT_WHALE = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:beach", 4);
    ...
    public static final SpawnBiomeData LEAFCUTTER_ANTHILL = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:forest", 7)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "regions_unexplored:bamboo_forest", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:forest", 8);
    ...
    public static final SpawnBiomeData BALD_EAGLE = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:taiga", 24)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 25)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:stony_shores", 25);
    ...
    public static final SpawnBiomeData SEAGULL = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 10)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:stony_shores", 10);
    ...
    public static final SpawnBiomeData ROCKY_ROLLER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:underground", 5);
    ...
    public static final SpawnBiomeData COMB_JELLY = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:ocean", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:deep_ocean", 3);
    ...
    public static final SpawnBiomeData CATFISH = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:swamp", 5)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:river", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 6)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "byg:white_mangrove_marshes", 7);
    ...
    public static final SpawnBiomeData LARGE_CATFISH = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, true, "byg:white_mangrove_marshes", 4);
    ...
    public static final SpawnBiomeData FLYING_FISH = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:ocean", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_cold", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_hot", 1);

    public static final SpawnBiomeData SKELEWAG = new SpawnBiomeData()
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_deep_ocean", 0)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:deep_ocean", 0);
    ...
    public static final SpawnBiomeData POTOO = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:vegetation_dense", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:jungle", 2);
    ...
    public static final SpawnBiomeData MUDSKIPPER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:swamp", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:beach", 3)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:river", 4)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 5)
    ...
    public static final SpawnBiomeData RHINOCEROS = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:savanna", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:desert", 9);
    ...
    public static final SpawnBiomeData SUGAR_GLIDER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 7)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "byg:crag_gardens", 7)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 8)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "magicalforest:magical_forest", 8)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 9)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "byg:temperate_rainforest", 9)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 10)
            .addBiomeEntry(BiomeEntryType.REGISTRY_NAME, false, "byg:guiana_shield", 10);
    ...
    public static final SpawnBiomeData FARSEER = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 1)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:mushroom", 2);
    ...
    public static final SpawnBiomeData BANANA_SLUG = new SpawnBiomeData()
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_hot", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 2)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 3)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_hot", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 11)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "minecraft:is_overworld", 12)
            ...
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_hot", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, true, "c:climate_temperate", 12)
            .addBiomeEntry(BiomeEntryType.BIOME_TAG, false, "c:climate_cold", 12);
}
